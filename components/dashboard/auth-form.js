      ...
      {providers.google || providers.facebook ? (
        <div className="space-y-3">
          <div className="flex items-center gap-3">
            ...
            <span className="text-xs font-medium uppercase tracking-[0.25em] text-slate-500">Social Login</span>
            <div className="h-px flex-1 bg-border" />
          </div>
          <div className="grid gap-3">
            ...
            {providers.facebook ? (
              <Button variant="secondary" className="w-full" onClick={() => signIn("facebook", { callbackUrl: "/dashboard" })}>
